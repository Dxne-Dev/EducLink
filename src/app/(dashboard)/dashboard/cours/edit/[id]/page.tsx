...
export const metadata = { title: 'Edulink - Modifier la ressource' }
...
export default async function EditResourcePage({
  ...
  if (!isTeacherOrAdmin) redirect('/dashboard/cours')
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      <div>
        <h1 className="text-heading-2 text-ink">Modifier la ressource</h1>
