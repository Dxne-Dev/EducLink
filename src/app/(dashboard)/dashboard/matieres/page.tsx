...
import { BookMarked, GraduationCap, BookOpen, Users, FileText } from 'lucide-react'

export const metadata = { title: 'Edulink — Mes Matières' }

export default async function MesMatieresPage() {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <Link
                            href={`/dashboard/mes-cours?matiere=${m.id}`}
