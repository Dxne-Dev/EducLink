...
export default async function MesProfsPage() {
        ...
        <Card>
          <CardContent className="py-8">
            <EmptyState
              ...
              description="Votre profil n'a pas encore de filière assignée. Rendez-vous dans vos paramètres ou contactez l'administration."
            />
          </CardContent>
        </Card>
      ) : teachers.length === 0 ? (
            ...
            <Card key={prof.id} className="transition-all hover:shadow-level-1">
              <CardContent className="p-5 space-y-4">
                ...
                <div className="border-t border-hairline pt-3 flex items-center justify-between">
                  ...
                  {prof.profileId ? (
                    <Link
                      href={`/dashboard/ressources?prof=${encodeURIComponent(prof.name)}`}
